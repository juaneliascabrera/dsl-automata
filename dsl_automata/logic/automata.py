...
class Automata(ABC):
    ...
    def valid_automata(self, states, alphabet, initial, final, transitions):
        ...
        self.validate_all_transitions_states_in_states_set(alphabet, states, transitions)

    def validate_all_transitions_states_in_states_set(self, alphabet, states, transitions):
